...
-- =====================================================
-- Supprimer et recréer pour avoir le bon schéma
...
DROP INDEX IF EXISTS idx_reclamations_status;
DROP INDEX IF EXISTS idx_reclamations_date;
DROP INDEX IF EXISTS idx_reclamations_reference;
...
DROP TRIGGER IF EXISTS trg_reclamation_reference ON reclamations;
...
-- =====================================================
-- Ne pas supprimer si existe déjà, juste ajouter les colonnes manquantes
CREATE TABLE IF NOT EXISTS veille_reglementaire (
  ...
  -- Source et type
  source TEXT NOT NULL DEFAULT 'Légifrance', -- 'Code du travail', 'INRS', 'Légifrance', etc.
...
-- Index
DROP INDEX IF EXISTS idx_veille_status;
DROP INDEX IF EXISTS idx_veille_date;
...
DROP TRIGGER IF EXISTS trg_veille_reference ON veille_reglementaire;
