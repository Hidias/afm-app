...
export default function AuditLogs() {
  const { auditLogs, auditLogsLoading, fetchAuditLogs } = useDataStore()
  ...
  const loadLogs = async () => {
    await fetchAuditLogs({
      ...
      fromDate: filterFromDate ? new Date(filterFromDate).toISOString() : null,
      toDate: filterToDate ? new Date(filterToDate + 'T23:59:59').toISOString() : null,
      limit: 200
    })
  }
