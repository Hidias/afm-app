...
export default function Indicateurs() {
  ...
  const calcHotStats = () => {
    ...
    // Taux de recommandation : toutes les évaluations qui ont répondu à would_recommend
    ...
    // Évaluations avec au moins une réponse (questionnaire soumis ou note manuelle)
