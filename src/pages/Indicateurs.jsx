...
export default function Indicateurs() {
  ...
  const calcHotStats = () => {
    ...
    const criteria = [
      ...
      { key: 'q2_content', label: 'Clarté du contenu' },
      { key: 'q3_trainer', label: 'Qualité du formateur' },
      { key: 'q4_methods', label: 'Méthodes pédagogiques' },
      ...
      { key: 'satisfaction_score', label: 'Note globale' },
    ]
