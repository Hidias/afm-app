...
export default function Indicateurs() {
  ...
  const calcHotStats = () => {
    ...
    const criteria = [
      ...
      { key: 'q2_organization', label: 'Accueil et organisation' },
      { key: 'q3_content', label: 'Pertinence du contenu' },
      { key: 'q4_materials', label: 'Supports pédagogiques' },
      { key: 'q5_trainer', label: 'Pédagogie du formateur' },
      { key: 'q6_duration', label: 'Rythme et durée' },
      { key: 'q7_conditions', label: 'Conditions matérielles' },
  ...
  // Calcul des taux pour évaluations à froid (Oui/Non)
  const calcColdStats = () => {
  ...
  // Calcul note globale (basé sur évaluations à chaud et formateur uniquement)
  const globalScore = () => {
    let total = 0, count = 0
