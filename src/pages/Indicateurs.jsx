...
export default function Indicateurs() {
  ...
  const calcHotStats = () => {
    ...
    // Critères Qualiopi - utilise les nouvelles colonnes OU les anciennes selon ce qui est rempli
    const criteriaGroups = [
      { 
        label: 'Organisation et accueil', 
        keys: ['q_org_accueil', 'q_org_documents', 'q_org_locaux', 'q_org_materiel', 'q6_organization'] 
      },
      { 
        label: 'Contenu et supports', 
        keys: ['q_contenu_supports', 'q_contenu_programme', 'q_contenu_organisation', 'q2_content', 'q5_materials'] 
      },
      { 
        label: 'Formateur / Pédagogie', 
        keys: ['q_formateur_pedagogie', 'q_formateur_expertise', 'q_formateur_progression', 'q3_trainer'] 
      },
      { 
        label: 'Durée et rythme', 
        keys: ['q_contenu_duree', 'q7_duration'] 
      },
      { 
        label: 'Adéquation et compétences', 
        keys: ['q_global_adequation', 'q_global_competences', 'q8_applicability', 'q1_objectives'] 
      },
      { 
        label: 'Satisfaction globale', 
        keys: ['satisfaction_score'] 
      },
    ]
    ...
    // Calculer la satisfaction globale (moyenne de toutes les notes)
    const allScores = []
    filteredHotEvals.forEach(e => {
      const allKeys = [
    ...
    // Évaluations avec au moins une réponse
    const evalsWithData = filteredHotEvals.filter(e => 
      e.questionnaire_submitted || 
      e.satisfaction_score !== null || 
      e.q1_objectives !== null ||
