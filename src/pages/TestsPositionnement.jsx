...
const PREDEFINED_THEMES = [
  ...
  { id: 'CACES-R485-INI', name: 'Conduite - R485 Gerbeurs accompagnant (initial)', category: 'CACES' },
  { id: 'CACES-R489-INI', name: 'Conduite - R489 Chariots portés (initial)', category: 'CACES' },
]
...
export default function TestsPositionnement() {
  ...
  const findMatchingPredefinedTheme = (theme) => {
    ...
    if (name.includes('r485') || name.includes('gerbeur')) return 'CACES-R485-INI'
    if (name.includes('r489') || name.includes('chariot')) return 'CACES-R489-INI'
