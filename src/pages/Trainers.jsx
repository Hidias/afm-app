            ...
            <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md">
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div><p className="text-gray-500">Email</p><p className="font-medium">{selectedTrainer.email || '-'}</p></div>
                  <div><p className="text-gray-500">Téléphone</p><p className="font-medium">{selectedTrainer.phone || '-'}</p></div>
                </div>
