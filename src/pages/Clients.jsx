      ...
      {showForm && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="relative min-h-full flex items-center justify-center p-4">
            <div className="relative bg-white rounded-xl shadow-xl w-full max-w-xl animate-fadeIn max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="p-4 space-y-4">
                ...
                <div className="border-t pt-4 mt-4">
                  <h3 className="text-sm font-medium text-gray-700 mb-3">Contact principal (pour conventions et convocations)</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
