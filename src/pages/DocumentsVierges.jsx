...
const getThemeColor = (themeName) => {
  ...
  if (name.includes('r489') || name.includes('r485') || name.includes('conduite') || name.includes('chariot') || name.includes('nacelle')) {
    return '#1f2937' // Noir
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 className="font-medium text-blue-800 mb-2">Indicateurs RNQ</h3>
        <p className="text-sm text-blue-700">
          Les badges (Q4, Q8, Q11, etc.) indiquent l'indicateur RNQ auquel correspond chaque document.
