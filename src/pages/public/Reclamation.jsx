    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-500 to-primary-700 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 mt-2">Access Formation - Qualité Qualiopi</p>
        </div>
        ...
        <p className="text-center text-white/60 text-sm mt-6">
          © {new Date().getFullYear()} Access Formation SARL - Organisme certifié Qualiopi
        </p>
      </div>
    </div>
  )
