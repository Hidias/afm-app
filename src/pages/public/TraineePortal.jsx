...
import { 
  ...
  Loader2, Calendar, Star, MessageSquare, ExternalLink
} from 'lucide-react'
          ...
          {currentStep === 'info_sheet' && selectedTrainee && (
            <form onSubmit={handleSubmitInfoSheet} className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                {formErrors.csp && <p className="text-red-500 text-xs">{formErrors.csp}</p>}
                ...
                />
                {formErrors.job_title && <p className="text-red-500 text-xs">{formErrors.job_title}</p>}
              </div>
