                ...
                {(() => {
                  ...
                  return (
                    <div className={`p-4 rounded-lg border-2 ${afternoonDone ? 'border-green-500 bg-green-50' : morningDone ? 'border-gray-200' : 'border-gray-100 bg-gray-50'}`}>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <Moon className={`w-6 h-6 ${afternoonDone ? 'text-green-600' : morningDone ? 'text-blue-500' : 'text-gray-300'}`} />
                          <div>
                            <p className={`font-medium ${!morningDone && !afternoonDone ? 'text-gray-400' : ''}`}>Après-midi</p>
                            <p className="text-xs text-gray-500">
                              {!morningDone && !afternoonDone ? 'Signez d\'abord le matin' : '2ème demi-journée'}
                            </p>
                          </div>
                        </div>
                        {afternoonDone ? (
