...
export default function TraineePortal() {
  ...
  const handleSubmitInfoSheet = async (e) => {
    ...
    // Validation SSN si pas refusé
    if (!infoForm.ssn_refused && (!infoForm.ssn || infoForm.ssn.length !== 15)) {
      alert('Veuillez saisir votre numéro de sécurité sociale (15 chiffres) ou cocher la case de refus.')
      return
    }
            ...
            <form onSubmit={handleSubmitInfoSheet} className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <input
                    ...
                    onChange={(e) => setInfoForm({...infoForm, last_name: e.target.value.toUpperCase()})}
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 -mt-2">Pour recevoir votre certificat de compétences</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                {!infoForm.ssn_refused && (
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setInfoForm({...infoForm, ssn: value})
                    }}
                    className="w-full px-3 py-2 border rounded-lg text-sm font-mono tracking-wider"
                    maxLength={15}
                  />
                )}
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-600">Je refuse de communiquer mon numéro de sécurité sociale</span>
                </label>
              </div>
