...
export default function Trainees() {
  ...
  const filtered = trainees.filter(t => {
    const matchSearch = `${t.first_name} ${t.last_name} ${t.email}`.toLowerCase().includes(search.toLowerCase())
              ...
              <tr key={t.id} className="hover:bg-gray-50">
                ...
                <td className="py-3 px-4 text-right">
                  <div className="flex justify-end gap-1">
                    ...
                    <button onClick={() => handleDelete(t.id)} className="p-2 hover:bg-gray-100 rounded" title="Supprimer"><Trash2 className="w-4 h-4 text-red-500" /></button>
                  </div>
                </td>
              </tr>
            ))}
              ...
              <div className="p-4 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" className="input" value={form.first_name} onChange={(e) => setForm({...form, first_name: e.target.value})} />
                  </div>
                  <div>
                    <label className="label">Nom *</label>
                    <input type="text" className="input" value={form.last_name} onChange={(e) => setForm({...form, last_name: e.target.value})} />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="text" className="input" value={form.social_security_number} onChange={(e) => setForm({...form, social_security_number: e.target.value})} />
                </div>
                <div>
