...
const versions = [
  {
    ...
    type: 'minor',
    changes: [
      'Évaluation à chaud Qualiopi complète (9 critères : objectifs, contenu, formateur, méthodes, supports, organisation, durée, applicabilité, note globale)',
      'Évaluation à froid complète (connaissances retenues, compétences appliquées, objectifs atteints, impact métier)',
      'Affichage formation/formateur dans toutes les sections évaluations',
      'Export complet des données en JSON depuis Paramètres (sauvegarde manuelle)',
      'Indicateurs mis à jour avec tous les critères Qualiopi',
      'Correction noms de colonnes SQL alignés avec l\'interface',
    ]
  },
  {
    version: 'V2.5.3',
