...
const versions = [
  {
    ...
    type: 'major',
    changes: [
      '🆕 CSP (Catégorie Socio-Professionnelle INSEE) et Poste obligatoires dans le portail stagiaire',
      '🆕 Gestion des départs anticipés (abandons) avec date et motif dans l\'onglet Présence',
      '📊 Taux d\'abandon dans les Indicateurs Qualiopi (Indicateur 2)',
      '🆕 Modal Situation/Financement par stagiaire dans les sessions',
      '✏️ Champs CSP et Poste éditables dans la fiche stagiaire admin',
      '📈 Indicateurs : 5 KPIs (Score, Réussite, Présence, Abandon, Recommandation)',
      '✅ Alignement Qualiopi V9 : traçabilité complète des stagiaires',
    ]
  },
  {
    version: 'V2.5.24',
