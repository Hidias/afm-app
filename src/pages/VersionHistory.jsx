...
const versions = [
  {
    ...
    type: 'minor',
    changes: [
      'Aperçu stagiaire avec N° Sécurité Sociale (Passeport Prévention)',
      'Aperçu formateur avec qualifications en badges',
      'Aperçu client avec contacts multiples',
      'Badge Interne (vert) / Externe (gris) pour formateurs',
      'Qualifications formateurs en badges avec ajout dynamique',
      'Filtre par qualifications sur la page Formateurs',
      'Formatage automatique NOM/Prénom à la saisie',
      'Confirmation avant toute suppression (modal)',
      'Icônes de suppression en rouge',
      'Colonne "Prénom NOM" dans la liste stagiaires',
    ]
  },
  {
    version: 'V2.5.5',
