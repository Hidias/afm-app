...
const versions = [
  {
    ...
    type: 'major',
    changes: [
      '🔐 RGPD : Chiffrement des N° de sécurité sociale (AES-256 via pgcrypto)',
      '🔐 Clé de chiffrement stockée sécurisée dans Supabase',
      '🔐 Déchiffrement uniquement à la consultation de la fiche',
      '📝 AUDIT LOGS : Journal complet des accès et modifications',
      '📝 Traçabilité : qui consulte quelle fiche, quand',
      '📝 Filtrage par action, entité, utilisateur, date',
      '📝 Nouvelle page "Audit RGPD" dans le menu',
      '📤 EXPORT RGPD : Bouton "Export RGPD" sur chaque fiche stagiaire',
      '📤 Téléchargement JSON avec toutes les données personnelles',
      '📤 Respect du droit d\'accès (article 15 RGPD)',
      '🗑️ PURGE AUTOMATIQUE : Détection des stagiaires > 5 ans sans formation',
      '🗑️ Alerte sur le Dashboard si stagiaires à purger',
      '🗑️ Fonction d\'archivage avant suppression définitive',
      '🛡️ Conservation des logs d\'audit 2 ans',
    ]
  },
  {
    version: 'V2.5.13',
