...
export default function Courses() {
  ...
  const [form, setForm] = useState({
    ...
    material: '', trainer_equipment: '', theme_id: ''
  })
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl my-8">
            ...
            <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="label">Matériel requis (formateur)</label>
                  <input type="text" className="input" placeholder="Ex: Mannequins, défibrillateur, extincteurs..." value={form.trainer_equipment} onChange={(e) => setForm({...form, trainer_equipment: e.target.value})} />
                </div>
              </div>
            </div>
