...
import { Save, Building2, Image, FileText, BookOpen, Upload, Trash2, Loader2, Check, History } from 'lucide-react'
import toast from 'react-hot-toast'

export default function Settings() {
  const { organization, fetchOrganization, updateOrganization } = useDataStore()
      ...
      <div className="card bg-white p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Version 2.5.1</p>
          </div>
