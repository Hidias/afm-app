...
import { Save, Building2, Image, FileText, BookOpen, Upload, Trash2, Loader2, Check, History, Download, Database, Users, LogOut, ExternalLink } from 'lucide-react'
      ...
      <div className="card bg-white p-6">
        ...
        <div className="text-sm text-gray-500 mb-4 space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>Non-conformités, indicateurs RNQ</li>
      ...
      <div className="card bg-white p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Version 2.5.14</p>
          </div>
