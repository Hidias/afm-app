...
const versions = [
  {
    ...
    type: 'new',
    changes: [
      { type: 'new', text: 'Documents éditables : bouton "Éditer" sur les lettres de désignation (génère PDF personnalisé)' },
      { type: 'new', text: 'Upload programme PDF sur les formations avec lien de téléchargement' },
      { type: 'new', text: 'Pack Qualité : 40 documents avec pieds de page complets' },
      { type: 'improve', text: 'Menu réorganisé : Documents + Docs vierges, Tests dans Formations, Audit RGPD dans Paramètres' },
      { type: 'fix', text: 'Correction alerte J+90 (table evaluations_cold)' },
      { type: 'fix', text: 'Suppression mentions RNQ → remplacées par Qualiopi ou Qualité' },
    ]
  },
  {
    version: '2.5.22',
