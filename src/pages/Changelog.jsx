...
const versions = [
  {
    ...
    type: 'new',
    changes: [
      { type: 'new', text: 'Pack Qualité RNQ complet : 40 documents (procédures, registres, lettres, formulaires)' },
      { type: 'new', text: 'Branding Access Formation sur tous les documents (logo, pied de page 4 lignes)' },
      { type: 'new', text: 'Page "Qualité" avec navigation par catégories et téléchargement direct' },
      { type: 'improve', text: 'Menu réorganisé : Documents fusionné avec Docs vierges (onglets)' },
      { type: 'improve', text: 'Tests positionnement intégrés dans Formations (onglet)' },
      { type: 'improve', text: 'Audit RGPD intégré dans Paramètres (onglet)' },
      { type: 'improve', text: 'Remplacement "Qualiopi" → "RNQ" dans toute l\'application' },
      { type: 'fix', text: 'Alerte J+90 disparaît quand TOUS les stagiaires ont reçu l\'évaluation à froid' },
    ]
  },
  {
    version: '2.5.22',
