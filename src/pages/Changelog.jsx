...
const versions = [
  {
    ...
    type: 'new',
    changes: [
      { type: 'new', text: 'Champs CSP (Catégorie Socio-Professionnelle INSEE) et Poste obligatoires dans le portail stagiaire' },
      { type: 'new', text: 'Gestion des départs anticipés (abandons) avec date et motif dans l\'onglet Présence' },
      { type: 'new', text: 'Taux d\'abandon dans les Indicateurs Qualiopi (Indicateur 2)' },
      { type: 'new', text: 'Modal Situation/Financement par stagiaire dans les sessions' },
      { type: 'new', text: 'Champs CSP et Poste éditables dans la fiche stagiaire admin' },
      { type: 'improve', text: 'Indicateurs : 5 KPIs (Score, Réussite, Présence, Abandon, Recommandation)' },
      { type: 'improve', text: 'Alignement Qualiopi V9 : traçabilité complète des stagiaires' },
    ]
  },
  {
    version: '2.5.24',
