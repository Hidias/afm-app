...
export default function Dashboard() {
  ...
  const stats = [
    { name: 'Clients', value: clients.length, icon: Building2, href: '/clients', color: 'bg-blue-500' },
    { name: 'Formations', value: courses.length, icon: GraduationCap, href: '/formations', color: 'bg-purple-500' },
    { name: 'Stagiaires', value: trainees.length, icon: Users, href: '/stagiaires', color: 'bg-green-500' },
