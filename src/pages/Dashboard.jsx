...
export default function Dashboard() {
  ...
  const [globalStats, setGlobalStats] = useState({ tauxSatisfaction: 0, tauxRecommandation: 0, tauxPresence: 0, tauxReponse: 0, tauxReussite: 0 })
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
          <Award className="w-5 h-5 text-amber-500" /> Indicateurs de résultats (sessions terminées)
        </h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <StatBar label="Taux de réussite" value={globalStats.tauxReussite} icon={Target} />
