...
import { 
  ...
  Settings, LogOut, Menu, X, FileText, AlertTriangle, UserCheck, FileStack, ClipboardList, BarChart3, Award, Shield,
  Bell, Check, ExternalLink, FolderCheck
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/documents-qualite', icon: FolderCheck, label: 'Docs Qualité RNQ' },
  ...
  { to: '/audit-logs', icon: Shield, label: 'Audit RGPD' },
        ...
        <div className="flex flex-col flex-1 bg-primary-500">
          <div className="p-5 border-b border-primary-400">
            ...
            <div className="mt-2">
              ...
              <p className="text-xs text-white/60">V2.5.23</p>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-primary-400">
            ...
            <p className="text-center text-xs text-white/40 mt-3">Access Campus V2.5.23</p>
          </div>
        </div>
      </aside>
