...
import { 
  ...
  Settings, LogOut, Menu, X, FileText, AlertTriangle, UserCheck, FileStack, ClipboardList
} from 'lucide-react'
      ...
      <aside className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-1 bg-white border-r">
          <div className="p-6 border-b">
            ...
            <p className="text-xs text-primary-500 mt-1">V2.5</p>
          </div>
          ...
          <div className="p-4 border-t">
            ...
            <p className="text-center text-xs text-gray-400 mt-3">AFM V2.4</p>
          </div>
        </div>
      </aside>
