...
const CONTACTS = {
  'Hicham Saidi': { name: 'Hicham Saidi', phone: '06 35 20 04 28', email: 'hicham.saidi@accessformation.pro' },
  'Maxime Langlais': { name: 'Maxime Langlais', phone: '07 83 51 17 95', email: 'maxime.langlais@accessformation.pro' },
}
