...
function generateConvention(session, trainees = [], trainer = null, costs = []) {
  ...
  // Ligne de séparation avant Article 1
  doc.setDrawColor(100, 100, 100)
  doc.line(20, y, pw - 20, y)
  y += 8
  
  // ═══════════════════════════════════════════════════════════
  // ARTICLE 1 - Commence sur la même page
  // ═══════════════════════════════════════════════════════════
  doc.setFont('helvetica', 'bold')
  doc.setFontSize(10)
  ...
  doc.setFont('helvetica', 'normal')
  doc.text(course.target_audience || 'Tout public', 55, y)
  y += 5
  
  doc.setFont('helvetica', 'bold')
  doc.text('Prérequis :', 20, y)
  doc.setFont('helvetica', 'normal')
  doc.text(course.prerequisites || 'Aucun', 55, y)
  y += 5
