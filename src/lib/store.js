  ...
  fetchSessions: async () => {
    ...
    try {
      ...
      const [
        ...
        supabase.from('session_trainees').select('id, session_id, trainee_id, registration_date, result, early_departure, departure_date, departure_reason, situation, funding_type, presence_complete'),
